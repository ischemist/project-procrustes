...
def validate_task(value: Mapping[str, JSONValue]) -> Task: ...
...
def validate_execution_stats(value: Mapping[str, Mapping[str, float]]) -> ExecutionStats: ...
def write_execution_stats(value: Mapping[str, Mapping[str, float]], path: StrPath) -> None: ...
def create_manifest(
    action: str,
