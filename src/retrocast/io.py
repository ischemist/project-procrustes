...
# from retrocast.models.chem import EvaluationResults, Route, TargetIdentity
...
# def load_and_prepare_targets(file_path: Path) -> dict[str, TargetIdentity]:
#     """
#     Loads a file containing target IDs and SMILES, canonicalizes the SMILES,
#     and prepares a dictionary of TargetIdentity objects.
#     """
...
#     prepared_targets: dict[str, TargetIdentity] = {}
#     for target_id, raw_smiles in targets_raw.items():
#         try:
#             canon_smiles = canonicalize_smiles(raw_smiles)
#             prepared_targets[target_id] = TargetIdentity(id=target_id, smiles=canon_smiles)
...
# def load_smiles_index(path: Path) -> dict[str, TargetIdentity]:
#     """
...
#         converted_data = {smiles: TargetIdentity(id=target_id, smiles=smiles) for smiles, target_id in data.items()}
