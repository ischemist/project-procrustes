...
# v0.8.1 native-boundary performance
...
The exact samples are recorded in [`v0.8.1-python-vs-standalone-sample.json`](v0.8.1-python-vs-standalone-sample.json).
...
Exact measurements are recorded in [`v0.8.1-native-boundary-results.json`](v0.8.1-native-boundary-results.json).
