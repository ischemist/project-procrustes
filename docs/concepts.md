...
- **Operations:** Adapt raw payloads into prediction envelopes around canonical routes, collect routes onto the benchmark, deduplicate per target, optional sampling (keep first *n* routes)
