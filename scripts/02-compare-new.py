...
Usage:
    uv run scripts/02-compare-new.py --benchmark stratified-linear-600 --models dms-flash dms-wide dms-deep
"""
...
def main():
    ...
    tasks = [
        ...
        (plots.plot_overall_summary, "compare_overall_summary.html", {"models_stats": stats_list}),
